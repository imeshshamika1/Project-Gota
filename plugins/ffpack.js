...
if (Config.WORKTYPE == 'public') {
      ...
      Trex.addrex({pattern: 'jsjsnsjsjsnsbsjks', fromMe: false, desc: Ln,}, (async (message, match) => {
 ...
 Trex.addrex({ pattern: 'ff9 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰🍁🔱  Gota Bot  🔱🍁❱   ' ,quoted: message.data })

    }));
 
 Trex.addrex({ pattern: 'ff10 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff11 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
 ...
 Trex.addrex({ pattern: 'ff12 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff13 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff14 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff15 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff16 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff17 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff18 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff19 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff20 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff21 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff22 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff23 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff24 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff25 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff26 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff27 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff28 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff29 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff30 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff31 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff32 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff33 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff34 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff35 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff36 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff37 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff38 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff39 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff40 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff41 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff43 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff44 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff45 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff46 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff47 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff48 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff49 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff50 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff51 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff52 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff53 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff54 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff55 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff56 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff57 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff58 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
 ...
 Trex.addrex({pattern: 'jsjabakanaianao', fromMe: true, desc: Ln,}, (async (message, match) => {
 ...
 Trex.addrex({ pattern: 'ff9 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {

        if (match[1] === '' ) return await message.sendMessage(ll);

        var ttinullimage = await axios.get(`https://docs-jojo.herokuapp.com/api/meme-gen?top=%20&bottom=${encodeURIComponent(match[1])}&img=https://telegra.ph/file/ecf60ef31d7e75c2620fd.jpg`, { responseType: 'arraybuffer' })

        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰🍁🔱  Gota Bot  🔱🍁❱   ' })

    }));
 
 Trex.addrex({ pattern: 'ff10 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff11 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
 ...
 Trex.addrex({ pattern: 'ff12 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff13 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
        if (match[1] === '' ) return await message.sendMessage(ll);
  ...
  Trex.addrex({ pattern: 'ff14 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff15 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff16 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff17 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff18 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff19 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff20 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff21 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff22 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff23 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff24 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff25 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff26 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff27 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff28 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff29 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff30 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff31 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff32 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff33 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff34 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff35 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff36 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff37 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff38 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff39 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff40 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff41 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff42 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff43 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff44 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff45 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff46 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff47 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff48 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff49 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff50 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff51 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff52 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff53 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff54 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff55 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff56 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff57 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Trex.addrex({ pattern: 'ff58 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
 ...
 Trex.addrex({ pattern: 'otrex ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
 ...
 Trex.addrex({ pattern: 'otrex ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
