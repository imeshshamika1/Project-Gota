...
if (Config.WORKTYPE == 'private') {
    ...
    Trex.addrex({pattern: 'carbon$', fromMe: true,  deleteCommand: false,  desc: Lang.CARBON_DESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
