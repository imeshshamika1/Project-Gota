...
if (Config.LANG == 'EN') {
 ...
 if (Config.WORKTYPE == 'public') {
  ...
  Trex.addrex({ pattern: 'jajananajaj', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Trex.addrex({ pattern: 'jsssnssnsnsn', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   await message.client.sendMessage(message.jid,alive, MessageType.audio, {mimetype: 'audio/mp4', ptt:true, quoted: message.data})
  }));
