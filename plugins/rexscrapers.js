...
﹏﹏﹏﹏﹏✪✭✪﹏﹏﹏﹏﹏
   『T Rex Whatsapp Bot』`,MessageType.text);
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, {mimetype: Mimetype.mp4, caption: "❰🍁🔱  Gota Bot  🔱🍁❱"});
        });
    }));
    ...
    Trex.addrex({ pattern: 'insta ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {caption: "❰🍁🔱  Gota Bot  🔱🍁❱"}) 
        }
          })
          .catch(
    ...
    Trex.addrex({ pattern: 'fb ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.FBDESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: true}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'spdf ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.SPDF_DESC }, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: true,  deleteCommand: false, desc: Lang.CURRENCY_DESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'tts (.*)', fromMe: true,  deleteCommand: false, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'yt ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'wiki ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'img ?(.*)', fromMe: true, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'quote ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.QUOTE_DESC}, async (message, match) => {
    ...
    Trex.addrex({pattern: 'wame ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.WAME_DESC}, (async (message, match) => {    
    ...
    Trex.addrex({ pattern: 'github ?(.*)', fromMe: true,  deleteCommand: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Trex.addrex({ pattern: 'tk ?(.*)', fromMe: true,  deleteCommand: false, desc: TKlang.TK_DESC }, async (message, match) => {
...
﹏﹏﹏﹏﹏✪✭✪﹏﹏﹏﹏﹏
   『T Rex Whatsapp Bot』`,MessageType.text, {quoted: message.data});
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, {mimetype: Mimetype.mp4, quoted:message.data ,caption: "❰🍁🔱  Gota Bot  🔱🍁❱"});
        });
    }));
    ...
    Trex.addrex({ pattern: 'insta ?(.*)', fromMe: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {quoted: message.data}, {caption: "❰🍁🔱  Gota Bot  🔱🍁❱"}) 
        }
          })
          .catch(
      ...
      Trex.addrex({ pattern: 'fb ?(.*)', fromMe: false, desc: Lang.FBDESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: false}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'spdf ?(.*)', fromMe: false, desc: Lang.SPDF_DESC }, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'quote ?(.*)', fromMe: false, desc: Lang.QUOTE_DESC}, async (message, match) => {
        if (match[1] === 'xx') return await message.reply(Lang.NEED_LOCATIONA);
        const url = `https://api.quotable.io/random`;
        try {
            const response = await got(url);
    ...
    Trex.addrex({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: false, desc: Lang.CURRENCY_DESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'tts (.*)', fromMe: false, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'yt ?(.*)', fromMe: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'wiki ?(.*)', fromMe: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'img ?(.*)', fromMe: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'wame ?(.*)', fromMe: false, desc: Lang.WAME_DESC}, (async (message, match) => {    
        if (message.reply_message !== false) {
            await message.client.sendMessage(message.jid, Lang.WAME.format(message.reply_message.jid.split('@')[0], message.reply_message.jid.replace('@s.whatsapp.net', ' ')), MessageType.text, {
                quotedMessage: message.reply_message.data, contextInfo: {mentionedJid: [message.reply_message.jid.replace('c.us', 's.whatsapp.net')]}
            });
    ...
    Trex.addrex({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Trex.addrex({ pattern: 'tk ?(.*)', fromMe: false, desc: TKlang.TK_DESC }, async (message, match) => {
