...
if (Config.WORKTYPE == 'private') {
    ...
    Trex.addrex({pattern: 'tblend ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    Trex.addrex({pattern: 'tblend ?(.*)', fromMe: false, desc: Lang.T_DESC}, (async (message, match) => {    
